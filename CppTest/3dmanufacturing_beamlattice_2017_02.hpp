...
namespace Materialise {
	const std::string schema_CppTest_3dmanufacturing_beamlattice_2017_02_namespace = "http://schemas.microsoft.com/3dmanufacturing/beamlattice/2017/02";
...
bool Materialise::CT_Mesh::Read(IXmlSerializerReader& s, const std::string& __name__) {
	...
	if (!scope.exist())
		return false;
	Materialise::beamlattice* __beamlattice = new Materialise::beamlattice();
	if (__beamlattice->Read(s, "beamlattice"))
		beamlattice = std::optional<std::unique_ptr<Materialise::beamlattice>> { __beamlattice };
	return true;
}
Materialise::CT_BeamLattice::CT_BeamLattice(Materialise::CT_BeamLattice &&___CT_BeamLattice) noexcept
	: minlength(std::move(___CT_BeamLattice.minlength))
	, radius(std::move(___CT_BeamLattice.radius))
	, clippingmode(std::move(___CT_BeamLattice.clippingmode))
	, clippingmesh(std::move(___CT_BeamLattice.clippingmesh))
	, representationmesh(std::move(___CT_BeamLattice.representationmesh))
	, pid(std::move(___CT_BeamLattice.pid))
	, pindex(std::move(___CT_BeamLattice.pindex))
	, cap(std::move(___CT_BeamLattice.cap))
...
bool Materialise::CT_BeamLattice::Read(IXmlSerializerReader& s, const std::string& __name__) {
	...
	beams.Read(s, "beams");
	Materialise::beamsets* __beamsets = new Materialise::beamsets();
	if (__beamsets->Read(s, "beamsets"))
		beamsets = std::optional<std::unique_ptr<Materialise::beamsets>> { __beamsets };
	return true;
}
Materialise::CT_Beam::CT_Beam(Materialise::CT_Beam &&___CT_Beam) noexcept
	: v1(std::move(___CT_Beam.v1))
	, v2(std::move(___CT_Beam.v2))
	, r1(std::move(___CT_Beam.r1))
	, r2(std::move(___CT_Beam.r2))
	, p1(std::move(___CT_Beam.p1))
	, p2(std::move(___CT_Beam.p2))
	, pid(std::move(___CT_Beam.pid))
	, cap1(std::move(___CT_Beam.cap1))
	, cap2(std::move(___CT_Beam.cap2))
{ }
...
Materialise::CT_BeamSet::CT_BeamSet(Materialise::CT_BeamSet &&___CT_BeamSet) noexcept
	: name(std::move(___CT_BeamSet.name))
	, identifier(std::move(___CT_BeamSet.identifier))
...
Materialise::CT_Ref::CT_Ref(Materialise::CT_Ref &&___CT_Ref) noexcept
	: index(std::move(___CT_Ref.index))
{ }
...
Materialise::beam::beam(Materialise::beam &&___beam) noexcept
	: v1(std::move(___beam.v1))
	, v2(std::move(___beam.v2))
	, r1(std::move(___beam.r1))
	, r2(std::move(___beam.r2))
	, p1(std::move(___beam.p1))
	, p2(std::move(___beam.p2))
	, pid(std::move(___beam.pid))
	, cap1(std::move(___beam.cap1))
	, cap2(std::move(___beam.cap2))
{ }
...
Materialise::beamset::beamset(Materialise::beamset &&___beamset) noexcept
	: name(std::move(___beamset.name))
	, identifier(std::move(___beamset.identifier))
...
Materialise::beamlattice::beamlattice(Materialise::beamlattice &&___beamlattice) noexcept
	: minlength(std::move(___beamlattice.minlength))
	, radius(std::move(___beamlattice.radius))
	, clippingmode(std::move(___beamlattice.clippingmode))
	, clippingmesh(std::move(___beamlattice.clippingmesh))
	, representationmesh(std::move(___beamlattice.representationmesh))
	, pid(std::move(___beamlattice.pid))
	, pindex(std::move(___beamlattice.pindex))
	, cap(std::move(___beamlattice.cap))
