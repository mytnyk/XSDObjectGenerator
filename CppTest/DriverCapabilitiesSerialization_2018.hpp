...
namespace Materialise {
	const std::string schema_CppTest_DriverCapabilitiesSerialization_2018_namespace = "http://schemas.materialise.com/BuildProcessor/2018";
...
Materialise::DriverCapabilities::DriverCapabilities(Materialise::DriverCapabilities &&___DriverCapabilities) noexcept
	...
	, NoMeshSupport(std::move(___DriverCapabilities.NoMeshSupport))
	, NoStandaloneSupport(std::move(___DriverCapabilities.NoStandaloneSupport))
	, SubcomponentProfileAssignment(std::move(___DriverCapabilities.SubcomponentProfileAssignment))
	, SupportsBeamLatticeCapModesButtAndSphere(std::move(___DriverCapabilities.SupportsBeamLatticeCapModesButtAndSphere))
...
Materialise::DriverPrivateCapabilities::DriverPrivateCapabilities(Materialise::DriverPrivateCapabilities &&___DriverPrivateCapabilities) noexcept
	: NoSupportsAsSubcomponents(std::move(___DriverPrivateCapabilities.NoSupportsAsSubcomponents))
	, SupportsToolpathGeneration(std::move(___DriverPrivateCapabilities.SupportsToolpathGeneration))
	, DriverIssues(std::move(___DriverPrivateCapabilities.DriverIssues))
	, FileIO(std::move(___DriverPrivateCapabilities.FileIO))
	, NonGenericProfiles(std::move(___DriverPrivateCapabilities.NonGenericProfiles))
	, NoDefaultProfiles(std::move(___DriverPrivateCapabilities.NoDefaultProfiles))
	, NoMeshSupport(std::move(___DriverPrivateCapabilities.NoMeshSupport))
	, NoStandaloneSupport(std::move(___DriverPrivateCapabilities.NoStandaloneSupport))
	, SubcomponentProfileAssignment(std::move(___DriverPrivateCapabilities.SubcomponentProfileAssignment))
	, SupportsBeamLatticeCapModesButtAndSphere(std::move(___DriverPrivateCapabilities.SupportsBeamLatticeCapModesButtAndSphere))
