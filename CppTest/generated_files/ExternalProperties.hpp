...
void Materialise::PropertyElement::Write(IXmlSerializerWriter& s) {
	IXmlSerializerWriter::Scope scope(s, "PropertyElement");
...
bool Materialise::PropertyElement::Read(IXmlSerializerReader& s) {
	IXmlSerializerReader::Scope scope(s, "PropertyElement");
...
void Materialise::ExternalPropertyFile::Write(IXmlSerializerWriter& s) {
	IXmlSerializerWriter::Scope scope(s, "ExternalPropertyFile");
	for(int i = 0;i < Properties.size();i++)
	{
		Properties[i].Write(s); 
	}
}
bool Materialise::ExternalPropertyFile::Read(IXmlSerializerReader& s) {
	IXmlSerializerReader::Scope scope(s, "ExternalPropertyFile");
	if (scope.exist() == false)
		return false;
	while (true) { 
