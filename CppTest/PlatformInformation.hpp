...
namespace Materialise {
	const std::string schema_CppTest_PlatformInformation_namespace = "http://www.materialise.com/BuildProcessor/2014";
...
Materialise::Choice2::Choice2(Materialise::Choice2 &&___Choice2) noexcept
	: id(std::move(___Choice2.id))
	, name(std::move(___Choice2.name))
	, isRequired(std::move(___Choice2.isRequired))
...
Materialise::Choice2Item::Choice2Item(Materialise::Choice2Item &&___Choice2Item) noexcept
	: id(std::move(___Choice2Item.id))
	, name(std::move(___Choice2Item.name))
	, isDefault(std::move(___Choice2Item.isDefault))
{ }
