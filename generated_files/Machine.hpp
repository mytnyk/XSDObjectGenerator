...
namespace Materialise {
	const std::string schema_generated_files_Machine_namespace = "";
...
Materialise::MachineCustomProperty::MachineCustomProperty(Materialise::MachineCustomProperty &&___MachineCustomProperty) noexcept
	: VariableName(___MachineCustomProperty.VariableName)
	, VariableType(___MachineCustomProperty.VariableType)
{ }
...
bool Materialise::Machine::Read(IXmlSerializerReader& s, const std::string& __name__) {
	...
	std::unique_ptr<Materialise::CustomProperties> __CustomProperties = std::make_unique<Materialise::CustomProperties>();
	if (__CustomProperties->Read(s, "CustomProperties"))
		CustomProperties = std::make_optional(std::move(__CustomProperties));
	return true;
}
