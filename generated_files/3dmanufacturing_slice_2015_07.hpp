...
namespace Materialise {
	const std::string schema_generated_files_3dmanufacturing_slice_2015_07_namespace = "http://schemas.microsoft.com/3dmanufacturing/slice/2015/07";
...
Materialise::CT_SliceStack::CT_SliceStack(Materialise::CT_SliceStack &&___CT_SliceStack) noexcept
	: id(___CT_SliceStack.id)
	, zbottom(___CT_SliceStack.zbottom)
...
bool Materialise::CT_Slice::Read(IXmlSerializerReader& s, const std::string& __name__) {
	...
	std::unique_ptr<Materialise::vertices> __vertices = std::make_unique<Materialise::vertices>();
	if (__vertices->Read(s, "vertices"))
		vertices = std::make_optional(std::move(__vertices));
	while (true) { 
...
Materialise::CT_SliceRef::CT_SliceRef(Materialise::CT_SliceRef &&___CT_SliceRef) noexcept
	: slicestackid(___CT_SliceRef.slicestackid)
	, slicepath(___CT_SliceRef.slicepath)
{ }
...
Materialise::sliceref::sliceref(Materialise::sliceref &&___sliceref) noexcept
	: slicestackid(___sliceref.slicestackid)
	, slicepath(___sliceref.slicepath)
{ }
