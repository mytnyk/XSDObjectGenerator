...
namespace Materialise {
	const std::string schema_generated_files_3dmanufacturing_core_2015_02_namespace = "http://schemas.microsoft.com/3dmanufacturing/core/2015/02";
...
Materialise::CT_Model::CT_Model(Materialise::CT_Model &&___CT_Model) noexcept
	: unit(___CT_Model.unit)
	, lang(___CT_Model.lang)
	, requiredextensions(___CT_Model.requiredextensions)
...
Materialise::CT_Base::CT_Base(Materialise::CT_Base &&___CT_Base) noexcept
	: name(___CT_Base.name)
	, displaycolor(___CT_Base.displaycolor)
{ }
...
Materialise::CT_Object::CT_Object(Materialise::CT_Object &&___CT_Object) noexcept
	: id(___CT_Object.id)
	, type(___CT_Object.type)
	, thumbnail(___CT_Object.thumbnail)
	, partnumber(___CT_Object.partnumber)
	, name(___CT_Object.name)
	, pid(___CT_Object.pid)
	, pindex(___CT_Object.pindex)
...
bool Materialise::CT_Object::Read(IXmlSerializerReader& s, const std::string& __name__) {
	...
	std::unique_ptr<Materialise::metadatagroup> __metadatagroup = std::make_unique<Materialise::metadatagroup>();
	if (__metadatagroup->Read(s, "metadatagroup"))
		metadatagroup = std::make_optional(std::move(__metadatagroup));
	mesh.Read(s, "mesh");
...
Materialise::CT_Triangle::CT_Triangle(Materialise::CT_Triangle &&___CT_Triangle) noexcept
	: v1(___CT_Triangle.v1)
	, v2(___CT_Triangle.v2)
	, v3(___CT_Triangle.v3)
	, p1(___CT_Triangle.p1)
	, p2(___CT_Triangle.p2)
	, p3(___CT_Triangle.p3)
	, pid(___CT_Triangle.pid)
{ }
...
Materialise::CT_Component::CT_Component(Materialise::CT_Component &&___CT_Component) noexcept
	: objectid(___CT_Component.objectid)
	, transform(___CT_Component.transform)
{ }
...
Materialise::CT_Metadata::CT_Metadata(Materialise::CT_Metadata &&___CT_Metadata) noexcept
	: name(___CT_Metadata.name)
	, preserve(___CT_Metadata.preserve)
	, type(___CT_Metadata.type)
{ }
...
Materialise::CT_Item::CT_Item(Materialise::CT_Item &&___CT_Item) noexcept
	: objectid(___CT_Item.objectid)
	, transform(___CT_Item.transform)
	, partnumber(___CT_Item.partnumber)
...
Materialise::model::model(Materialise::model &&___model) noexcept
	: unit(___model.unit)
	, lang(___model.lang)
	, requiredextensions(___model.requiredextensions)
...
Materialise::_base::_base(Materialise::_base &&____base) noexcept
	: name(____base.name)
	, displaycolor(____base.displaycolor)
{ }
...
Materialise::_object::_object(Materialise::_object &&____object) noexcept
	: id(____object.id)
	, type(____object.type)
	, thumbnail(____object.thumbnail)
	, partnumber(____object.partnumber)
	, name(____object.name)
	, pid(____object.pid)
	, pindex(____object.pindex)
...
Materialise::component::component(Materialise::component &&___component) noexcept
	: objectid(___component.objectid)
	, transform(___component.transform)
{ }
...
Materialise::metadata::metadata(Materialise::metadata &&___metadata) noexcept
	: name(___metadata.name)
	, preserve(___metadata.preserve)
	, type(___metadata.type)
{ }
...
Materialise::item::item(Materialise::item &&___item) noexcept
	: objectid(___item.objectid)
	, transform(___item.transform)
	, partnumber(___item.partnumber)
